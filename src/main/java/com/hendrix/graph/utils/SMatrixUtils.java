...
public class SMatrixUtils {
     ...
     *
     * @see com.hendrix.graph.utils.SEdgeUtils#indexOf(com.hendrix.graph.types.Edge, com.hendrix.graph.graphs.IGraph)
     * @see com.hendrix.graph.utils.SEdgeUtils#getEdgesIndices(com.hendrix.graph.graphs.IGraph)
     * @see com.hendrix.graph.utils.SEdgeUtils#getIndicesEdges(com.hendrix.graph.graphs.IGraph)
     * @see com.hendrix.graph.utils.SEdgeUtils#getEdgeAt(int, com.hendrix.graph.graphs.IGraph)
     * @see com.hendrix.graph.utils.SVertexUtils#getIndicesVertices(com.hendrix.graph.graphs.IGraph)
     * @see com.hendrix.graph.utils.SVertexUtils#getVertexAt(int, com.hendrix.graph.graphs.IGraph)
     * @see com.hendrix.graph.utils.SVertexUtils#getIndicesVertices(com.hendrix.graph.graphs.IGraph)
     * @see com.hendrix.graph.utils.SVertexUtils#getVerticesIndices(com.hendrix.graph.graphs.IGraph)
     *
     */
