...
public class SVertexUtils {
     ...
     * for frequent queries use {@link #getVerticesIndices(com.hendrix.graph.graphs.IGraph)}
     *
     ...
     * for frequent queries use {@link #getIndicesVertices(com.hendrix.graph.graphs.IGraph)}
     *
     ...
     *
     * @see #getIndicesVertices(com.hendrix.graph.graphs.IGraph)
     */
     ...
     * @return a correspondence mapping
     *
     * @see #getVerticesIndices(com.hendrix.graph.graphs.IGraph)
     */
