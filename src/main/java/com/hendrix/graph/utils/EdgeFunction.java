...
public class EdgeFunction implements IDisposable {
     ...
     * and use their {@link com.hendrix.graph.types.Edge#getWeight()} as the function value
     *
    ...
    /**
     * add all of the edges to the function and use their {@link com.hendrix.graph.types.Edge#getWeight()}
     * as the value
     *
     * @param edges a {@link java.util.Collection} of edges
     */
     ...
     *
     * @throws com.hendrix.graph.utils.EdgeFunction.NoFunctionValueException if there is no value
     */
