...
public class SEdgeUtils {
     ...
     * for frequent queries use {@link #getEdgesIndices(com.hendrix.graph.graphs.IGraph)}
     *
     ...
     * for frequent queries use {@link #getIndicesEdges(com.hendrix.graph.graphs.IGraph)}
     *
     ...
     *
     * @see #getIndicesEdges(com.hendrix.graph.graphs.IGraph)
     */
     ...
     * @return a correspondence mapping
     *
     * @see #getEdgesIndices(com.hendrix.graph.graphs.IGraph)
     */
