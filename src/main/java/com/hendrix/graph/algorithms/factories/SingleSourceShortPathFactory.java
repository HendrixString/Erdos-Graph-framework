...
import com.hendrix.graph.algorithms.AbstractShortestPathAlgorithm;
import com.hendrix.graph.algorithms.BellmanFordShortestPath;
import com.hendrix.graph.algorithms.DagShortestPaths;
...
public class SingleSourceShortPathFactory {
     ...
     * @param weightFunction    (Optional) a weight function, this is optional, if {@code null} is provided then {@link com.hendrix.graph.types.Edge#getWeight()} is used.
     *
