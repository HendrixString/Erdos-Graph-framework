...
public class BellmanFordShortestPath extends AbstractShortestPathAlgorithm<IDirectedGraph> {
     ...
     * @return
     *
     * @throws com.hendrix.graph.exceptions.GraphContainsNegativeWeightCycle
     */
    @Override
