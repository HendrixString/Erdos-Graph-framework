...
public class AllPairsShortPathResult implements ITag{
    ...
    /**
     * get vertex at specified index, uses a cached {@link com.hendrix.graph.utils.SVertexUtils#getIndicesVertices(com.hendrix.graph.graphs.IGraph)}
     *
    ...
    /**
     * get the index of a vertex, uses a cached {@link com.hendrix.graph.utils.SVertexUtils#getVerticesIndices(com.hendrix.graph.graphs.IGraph)}
     *
