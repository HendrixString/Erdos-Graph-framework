...
abstract public class AbstractShortestPathAlgorithm<E extends IGraph> extends GraphAlgorithm<ShortestPathsTree, E> {
    ...
    /**
     * an optional weight function. if not supplied, then {@link com.hendrix.graph.types.Edge#getWeight()} will be used
     */
    ...
    /**
     * a helper function for extracting weight. if a weight function was supplied with {@link #setWeightFunction(com.hendrix.graph.utils.EdgeFunction)}
     * then it will be used. otherwise {@link com.hendrix.graph.types.Edge#getWeight()} will be used.
     *
     ...
     * @return the weight
     *
     * @throws com.hendrix.graph.utils.EdgeFunction.NoFunctionValueException if there is no value and weight function was used
     */
