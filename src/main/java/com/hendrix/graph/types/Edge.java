package com.hendrix.graph.types;

import com.hendrix.graph.interfaces.IData;
import com.hendrix.graph.interfaces.IIdImmutable;
...
public class Edge implements IIdImmutable, ITag, IData<Object>
{
    ...
    /**
     * @see #getEdgeDesc(IVertex, IVertex, com.hendrix.graph.types.Edge.EDGE_DIRECTION)
     */
    ...
    /**
     * @see #getEdgeDesc(Edge, com.hendrix.graph.types.Edge.EDGE_DIRECTION)
